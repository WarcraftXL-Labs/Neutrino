...
param(
    ...
    [ValidateSet("all", "units", "shell", "log", "loop", "i18n", "extension", "static", "ui-layer", "widgets", "browser", "session", "single-instance")]
    [string]$Only = "all"
)
...
$suites = @("units", "shell", "log", "loop", "i18n", "extension", "static", "ui-layer", "widgets", "browser", "session", "single-instance")
