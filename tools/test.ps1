...
param(
    ...
    [ValidateSet("all", "units", "shell", "module", "static", "ui-layer", "widgets", "browser", "session", "single-instance")]
    [string]$Only = "all"
)
...
$suites = @("units", "shell", "module", "static", "ui-layer", "widgets", "browser", "session", "single-instance")
